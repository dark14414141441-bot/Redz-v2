 ...
 Themes = {
  Darker = {
   ["Color Hub 1"] = ColorSequence.new({
    ...
    ColorSequenceKeypoint.new(0.50, Color3.fromRGB(10, 18, 35)),
    ColorSequenceKeypoint.new(1.00, Color3.fromRGB(5, 10, 20))
   }),
   ["Color Hub 2"] = Color3.fromRGB(15, 25, 50),
   ["Color Stroke"] = Color3.fromRGB(30, 60, 120),
   ["Color Theme"] = Color3.fromRGB(50, 120, 220),
   ["Color Text"] = Color3.fromRGB(255, 255, 255),
   ["Color Dark Text"] = Color3.fromRGB(160, 185, 220)
  },
  Dark = {
   ["Color Hub 1"] = ColorSequence.new({
    ColorSequenceKeypoint.new(0.00, Color3.fromRGB(8, 14, 28)),
    ColorSequenceKeypoint.new(0.50, Color3.fromRGB(12, 22, 42)),
    ColorSequenceKeypoint.new(1.00, Color3.fromRGB(8, 14, 28))
   }),
   ["Color Hub 2"] = Color3.fromRGB(18, 30, 58),
   ["Color Stroke"] = Color3.fromRGB(35, 70, 140),
   ["Color Theme"] = Color3.fromRGB(60, 140, 255),
   ["Color Text"] = Color3.fromRGB(255, 255, 255),
   ["Color Dark Text"] = Color3.fromRGB(170, 195, 230)
  },
  Purple = {
   ["Color Hub 1"] = ColorSequence.new({
    ColorSequenceKeypoint.new(0.00, Color3.fromRGB(5, 8, 18)),
    ColorSequenceKeypoint.new(0.50, Color3.fromRGB(10, 18, 38)),
    ColorSequenceKeypoint.new(1.00, Color3.fromRGB(5, 8, 18))
   }),
   ["Color Hub 2"] = Color3.fromRGB(12, 20, 45),
   ["Color Stroke"] = Color3.fromRGB(25, 55, 115),
   ["Color Theme"] = Color3.fromRGB(55, 130, 240),
   ["Color Text"] = Color3.fromRGB(255, 255, 255),
   ["Color Dark Text"] = Color3.fromRGB(155, 185, 225),
   ["Color Dark Purple"] = Color3.fromRGB(100, 160, 255),
   ["Color Hub 9"] = Color3.fromRGB(0, 0, 0),
   ["Color Dark Greem"] = Color3.fromRGB(100, 160, 255)
  }
 },
 Info = {
  Version = "1.2.0"
...
function redzlib:Notify(Configs)
	...
	local Image = Configs.Image or "rbxassetid://95903604257436"
	...
	local NotificationStroke = Create("UIStroke", NotificationFrame, {
		Color = Color3.fromRGB(25, 55, 110),
		Thickness = 2,
		ApplyStrokeMode = "Border"
	})
	...
	local DescLabel = Create("TextLabel", NotificationFrame, {
		...
		BackgroundTransparency = 1,
		Text = Description,
		TextColor3 = Color3.fromRGB(160, 185, 220),
		TextSize = 9,
		Font = Enum.Font.Gotham,
		TextXAlignment = "Left",
		TextWrapped = true
...
local function CreateCyberpunkParticle()
	...
	-- Partículas em tons de azul
	local blueShades = {
		Color3.fromRGB(50, 120, 220),
		Color3.fromRGB(30, 90, 180),
		Color3.fromRGB(80, 150, 255),
		Color3.fromRGB(20, 60, 140),
		Color3.fromRGB(100, 170, 255),
	}
	local particleColor = blueShades[math.random(1, #blueShades)]
...
local function SpawnCyberpunkSystem()
	...
	function Window:CloseBtn()
		local Dialog = Window:Dialog({
			Title = "Close",
			Text = "Deseja realmente fechar a Anonymous Hub? Ele contém recursos essenciais fechar ele pode Iniciar um Loop Infinito caso tenha alguma opção Permanente que só se Desactiva com um toque Pense Melhor!",
			Options = {
				{"Confirm", function()
					ScreenGui:Destroy()
				end},
...
function Tab:AddDiscordInvite(Configs)
	...
	local BannerArea = Create("ImageLabel", MainFrame, {
		...
		Image = BannerImage,
		BackgroundColor3 = Color3.fromRGB(20, 50, 120),
	...
	if BannerImage == "" then
		local BannerGradient = Create("UIGradient", BannerArea, {
			...
			Color = ColorSequence.new({
				ColorSequenceKeypoint.new(0, Color3.fromRGB(20, 50, 140)),
				ColorSequenceKeypoint.new(1, Color3.fromRGB(50, 100, 210))
			})
		})
	end
